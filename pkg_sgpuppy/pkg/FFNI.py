...
class PropagateMoments(object):
	"""
	Superclass for uncertainty.py propagation through deterministic functions
	"""
	...
	def __init__(self,func,mean):
		...
		:param mean: propagate uncertainty.py around this mean vector
		"""
		self.mean = mean
	...
	def propagate(self,Sigma_x, skew=False, kurtosis=False):
		"""
		Propagates a normal distributed uncertainty.py around self.mean through the deterministic function self.func.
