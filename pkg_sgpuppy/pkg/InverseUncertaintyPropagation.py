...
class InverseUncertaintyPropagation(object):
	...
	* :math:`n_i`: number of samples for input i
	...
	def __init__(self, output_variance, gp, u, c,I, input_variances=None, upga_class=UncertaintyPropagationExact, coestimated=[]):
		...
		:param u: Input vector where the uncertainty.py should be estimated
		:param upga_class: Class for uncertainty.py propagation with gaussian approximation
	...
	def get_best_solution(self):
		"""
		Calculate the inverse uncertainty.py propagation.

		:return: Optimal variances, that lead to the desired output uncertainty.py with minimal sampling cost
		"""
		pass
